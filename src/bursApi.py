...
#..............................................
def get_history(id,num):
    url8='http://members.tsetmc.com/tsev2/data/InstTradeHistory.aspx?i=%i&Top=%i&A=0'% (id,num)
...
def get_clienttype_all():
    ...
    for item in content4:
        item=item.split(',')
        try:
            ClientTypeAll.append ( dict(id=item[0],Buy_CountI=item[1],Buy_CountN=item[2],Buy_I_Volume=item[3],Buy_N_Volume=item[4],Sell_CountI=item[5],Sell_CountN=item[6],Sell_I_Volume=item[7],Sell_N_Volume=item[8]))
        except:
            pass
...
def sms_send(num,text):
    url = "https://www.payam-resan.com/APISend.aspx"
    data={'Username': '09130875016', 'Password': '0', 'From': '50002060123321','To': num,'Text': text}
